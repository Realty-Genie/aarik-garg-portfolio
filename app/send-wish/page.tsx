  ...
  return (
    <main className="min-h-screen bg-[oklch(89%_9%_76deg)] px-5 py-16 sm:px-8 lg:px-10">
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2 lg:gap-20">
        ...
        {/* Left — copy */}
        <div>
          <p className="text-2xl italic text-[#7b4d2a] [font-family:var(--font-libertinus),serif]">For Aarik</p>
          ...
          <p className="mt-8 text-2xl font-semibold leading-relaxed text-[#302215] [font-family:var(--font-libertinus),serif]">
            Write a wish.
          </p>
          <p className="mt-2 text-lg leading-8 text-[#543612] [font-family:var(--font-libertinus),serif]">
            Write something emotional, funny, dramatic, full of emojis, or all of the above. Aarik will treasure every single word when he&apos;s older. <span className="text-[#c88716]">♥</span>
          </p>
